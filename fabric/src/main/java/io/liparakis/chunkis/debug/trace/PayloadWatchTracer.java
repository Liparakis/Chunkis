...
public final class PayloadWatchTracer {
    ...
    public static void traceBlockSetStateEntered(
        ...
        BlockPayloadTracer.traceBlockSetStateEntered(chunk, pos, previous, next, flags, caller, passiveCause, mutationSuppressed, mutationAccepted, deltaCreated, blockChangesBefore, blockChangesAfter, mutationGeneration, message);
    }
        ...
        delta.getBlockEntities().long2ObjectEntrySet().forEach(entry -> {
            ...
            if (target != null) {
                traceWatch(
                        ...
                        operationId,
                        target,
                        PayloadWatchSummaries.summarizeBlockEntity(target, null, entry.getValue()),
                        byteSize
                );
            }
        });
    ...
    public static void traceRestoreInstructionVisited(
        ...
        RestorePayloadTracer.traceRestoreInstructionVisited(chunk, pos, previousState, expectedState, operationId, source);
    }
    ...
    public static void traceRestoreSetBlockReturned(
        ...
        RestorePayloadTracer.traceRestoreSetBlockReturned(chunk, pos, previousState, expectedState, operationId, source);
    }
    ...
    public static void traceRestoreStateAfterSetBlock(
        ...
        RestorePayloadTracer.traceRestoreStateAfterSetBlock(chunk, pos, previousState, expectedState, operationId, source);
    }
    ...
    public static void traceRestoreApplyFailed(
        ...
        RestorePayloadTracer.traceRestoreApplyFailed(chunk, pos, previousState, expectedState, operationId, source, reason);
    }
    ...
    public static void traceEntityReplayState(
        ...
        EntityPayloadTracer.traceEntityReplayState(world, chunk, expectedDelta, operationId, eventType, stage, source, message);
    }
    ...
    public static void traceLiveChunkState(
        ...
        ChunkLifecyclePayloadTracer.traceLiveChunkState(chunk, presentEventType, stage, source, operationId, expectedDelta);
    }
    ...
    @Nullable
    static NbtCompound findWatchedEntityNbt(
            final ChunkDelta<BlockState, NbtCompound> delta,
            final String entityUuid
    ) {
    ...
    static void traceRestoreMutationStage(
        ...
        traceWatch(
                ...
                "pos=" + pos.getX() + ',' + pos.getY() + ',' + pos.getZ()
                        ...
                        + " setNewBlockReturnValue=UNAVAILABLE_DIRECT_SECTION_WRITE"
